    ...
    public class MsBuildFileSetFactoryTest
    {
        ...
        public async Task FindsCustomWatchItems()
        {
            var project = _testAssets.CreateTestProject(new TestProject("Project1")
            {
                ...
                AdditionalItemSpecs =
                {
                    new TestItemSpec { Name = "Watch", Include = "*.js", Exclude = "gulpfile.js" },
                },
            });
        ...
        public async Task ExcludesDefaultItemsWithWatchFalseMetadata()
        {
            var project = _testAssets.CreateTestProject(new TestProject("Project1")
            {
                ...
                AdditionalItemSpecs =
                {
                    new TestItemSpec { Name = "EmbeddedResource", Include = "*.resx", Attributes = { ["Watch"] = "false" } },
                },
            });
        ...
        public async Task MultiTfm()
        {
            var project = _testAssets.CreateTestProject(new TestProject("Project1")
            {
                ...
                AdditionalItemSpecs =
                {
                    new TestItemSpec { Name = "Compile", Include = "Class1.netcore.cs", Attributes = { ["Condition"] = "'$(TargetFramework)'=='netcoreapp2.1'" } },
                    new TestItemSpec { Name = "Compile", Include = "Class1.desktop.cs", Attributes = { ["Condition"] = "'$(TargetFramework)'=='net461'" } },
                },
            });
        ...
        public async Task ProjectReferences_OneLevel()
        {
            ...
            AssertEx.EqualFileList(
                ...
                new[]
                {
                    ...
                    "src/Project2/Project2.cs",
                    "src/Project1/Project1.csproj",
                    "src/Project1/Project1.cs",
                },
                fileset
            );
        }
        ...
        private static string GetTestProjectDirectory(TestAsset testAsset)
            => Path.Combine(testAsset.Path, testAsset.TestProject.TargetSubDirectory ?? string.Empty, testAsset.TestProject.Name);
    }
}
